        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-5xl lg:text-7xl font-semibold tracking-tight text-slate-900 mb-6 leading-[1.1]">
              Transform Your Business with <span className="text-blue-600 italic">AI Strategy</span>.
            </h1>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {pillars.map((pillar, idx) => (
            <motion.div
              ...
              className="group p-8 rounded-3xl bg-white border border-blue-50 shadow-sm hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-500 hover:-translate-y-1"
            >
