    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mb-20">
          <h1 className="text-4xl lg:text-5xl font-semibold text-slate-900 mb-6">Expertise to Power Your AI Transformation</h1>
          <p className="text-xl text-slate-600 leading-relaxed">
            From strategic discovery to hands-on implementation, I provide the frameworks and guidance needed to turn AI potential into business reality.
          </p>
        </div>
        ...
        <section className="bg-blue-600 rounded-[2.5rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-200">
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-semibold text-white mb-6">Ready to get started?</h2>
            <p className="text-blue-100 text-lg mb-10">
              Let's discuss how these services can help transform your business with AI.
            </p>
            <Link
              to="/contact"
